...
class DocSchema(BaseModel):
	...
	language: Optional[str] = Field(
		None, description="The language of the document."
	)
	summary: Optional[str] = Field(
		None, description="A brief summary of the document in English."
	)
	...
	taxpayerName: Optional[str] = Field(
		None,
		description=(
			"The full name of the taxpayer or business entity as registered "
			"with the tax authority."
		),
	)
	registeredDate: Optional[str] = Field(
		None, description="The date the TIN was issued or registered in MM/DD/YYYY format."
	)
	registeredAddress: Optional[str] = Field(
